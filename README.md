...
게이밍 메신저인 DISCORD에서 만우절 기념으로 만든 클리커 게임인 LAST MEADOW를 모바일 버전으로 모작해보려고 합니다.
...
1주 UI 레이아웃 기초 - 뼈대 만들기 및 화면 디자인

2주 화면 전환 구현 - 각각의 버튼을 통한 화면전환

3주 어드벤쳐 버튼 클리커 구현 - 조작 및 타이머 로직

4주 제작 버튼 미니게임 구현 - 랜덤 배열 생성과 버튼 입력

5주 전투 화면 미니게임 구현 - 랜덤 그리드 생성
6주 데이터 통합 - 미니게임, 자원 등 데이터 연동
7주 데이터 저장 - 게임 진행상황 유지
8주 리소스 적용 및 마무리 - 임시 이미지 교체 및 다듬기
